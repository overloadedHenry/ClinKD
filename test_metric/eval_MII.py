...
if __name__ == "__main__":
    ...
    mean_metric_score = {'Bleu_1': 0, 'Bleu_2': 0, 'Bleu_3': 0, 'Bleu_4': 0, 'METEOR': 0, 'ROUGE_L': 0, 'CIDEr': 0}
    ...
    for modality in modality_score_dict.keys():
        ...
        tmp_res_file = f'{os.path.join("/data/coding/eval_results/coding--distilled_qwenvl_2024-12-22_00-02-11_nosample_nopad", json_name_item[:-5])}_tmp_res.json'
        ...
        tmp_anno_file = f'{os.path.join("/data/coding/eval_results/coding--distilled_qwenvl_2024-12-22_00-02-11_nosample_nopad", json_name_item[:-5])}_tmp_anno.json'
    ...
    metric_ls = ['Bleu_1', 'Bleu_2', 'Bleu_3', 'Bleu_4', "METEOR", "ROUGE_L"]
    mbmr = 0
    for item in metric_ls:
        mbmr += mean_metric_score[item]
    print("mBMR:", mbmr / 6)